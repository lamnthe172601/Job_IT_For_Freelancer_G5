...
public class PostDAO extends DBContext {
    ...
    public List<Post> TopPost(int uid) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Recruiter re = new Recruiter(rs.getInt("recruiterID"), uid,rs.getString("first_name"), rs.getString("last_name"), rs.getBoolean("gender"), rs.getDate("dob"), rs.getString("image"), rs.getString("email"), rs.getString("phone"), com);
