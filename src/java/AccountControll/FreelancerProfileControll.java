 ...
 * @author Admin
 */
public class FreelancerProfileControll extends HttpServlet {
   ...
   private FreelancerDAO freelancerDAO = new FreelancerDAO();
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FreelancerProfileControll</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FreelancerProfileControll at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
