<%-- 
    Document   : blank-page
    Created on : May 23, 2024, 1:17:31 AM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <!-- Mirrored from kofejob.dreamstechnologies.com/html/template/blank-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2024 10:34:58 GMT -->
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <script src="assets/js/jquery-3.7.1.min.js" type="55d209924e958c047bbe2695-text/javascript"></script>

        <script src="assets/js/bootstrap.bundle.min.js" type="55d209924e958c047bbe2695-text/javascript"></script>

        <script src="assets/js/slick.js" type="55d209924e958c047bbe2695-text/javascript"></script>

        <script src="assets/js/script.js" type="55d209924e958c047bbe2695-text/javascript"></script>
        <script src="assets/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="55d209924e958c047bbe2695-|49" defer></script></body>

    <!-- Mirrored from kofejob.dreamstechnologies.com/html/template/blank-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2024 10:35:00 GMT -->
</html>
