<%-- 
    ...
    Created on : May 23, 2024, 11:07:37 PM
    Author     : Admin
--%>
                            ...
                            <div class="blog-view">
                                <div class="blog-single-post pro-post widget-box">
                                    <div class="blog-image">
                                        <a href="javascript:void(0);"><img alt="Img" src="assets/img/blog/blog-01.jpg" class="img-fluid"></a>
                                    </div>
                                    ...
                                    <div class="about-author">
                                        <div class="about-author-img">
                                            <div class="author-img-wrap">
                                                <a href="developer-details.html"><img class="img-fluid" alt="Img" src="assets/img/img-02.jpg"></a>
                                            </div>
                                        </div>
                                        <div class="author-details">
                                            <a href="developer-details.html" class="blog-author-name">Web Designer</a>
                                    ...
                                    <div class="pro-content pb-0">
                                        <ul class="comments-list">
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt="Img" src="assets/img/img-02.jpg">
                                                    </div>
                                                ...
                                                <ul class="comments-list reply">
                                                    <li>
                                                        <div class="comment">
                                                            <div class="comment-author">
                                                                <img class="avatar" alt="Img" src="assets/img/img-03.jpg">
                                                            </div>
                                                            <div class="comment-block">
                                                                <span class="comment-by">
                                                    ...
                                                    <li>
                                                        <div class="comment">
                                                            <div class="comment-author">
                                                                <img class="avatar" alt="Img" src="assets/img/img-04.jpg">
                                                            </div>
                                                            <div class="comment-block">
                                                                <span class="comment-by">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt="Img" src="assets/img/img-05.jpg">
                                                    </div>
                                                    <div class="comment-block">
                                                        <span class="comment-by">
