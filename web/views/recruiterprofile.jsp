                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <div class="company-detail-block pt-0">
                                <div class="company-detail">
                                    ...
                                    <div class="company-title">
                                        <p>Company Name</p>
                                        <h4>${recruiter.getCompanyID().getCompanyName()}</h4>
                                    </div>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="proposal-detail text-capitalize">
                                                ...
                                                <p class="mb-0">${recruiter.getCompanyID().getTeamNumber()}</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="proposal-detail-img">
                                            ...
                                            <div class="proposal-detail text-capitalize">
                                                ...
                                                <p class="mb-0">${recruiter.getCompanyID().getEstablishedOn()}</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="proposal-detail-img">
                                            ...
                                            <div class="proposal-detail text-capitalize">
                                                ...
                                                <p class="mb-0">${recruiter.getCompanyID().getWebsite()}</p>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <div class="proposal-detail text-capitalize">
                                                ...
                                                <p class="mb-0">${recruiter.getCompanyID().getLocation()}</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="company-detail-block company-description">
                                ...
                                <p>${recruiter.getCompanyID().getDescribe()}</p>
