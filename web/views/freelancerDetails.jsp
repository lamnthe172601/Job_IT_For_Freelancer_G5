<%-- 
    Document   : developer_details
    Created on : May 23, 2024, 9:47:21 AM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <!-- Mirrored from kofejob.dreamstechnologies.com/html/template/developer-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2024 10:29:56 GMT -->
    <head>
        <meta charset="UTF-8">
    ...
    <body>
                                ...
                                <div class="budget-widget-details">
                                    ...
                                    <ul class="buget-profiles">
                                        ...
                                        <li>
                                            ...
                                            <h5><a href="https://kofejob.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bad3d4dcd5fadfc2dbd7cad6df94d9d5d7">[email&#160;protected]</a></h5>
                                        </li>
                                    </ul>
                                </div>
                                <div>
        ...
        <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>

        <script src="assets/js/bootstrap.bundle.min.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>

        <script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>
        <script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>

        <script src="assets/plugins/select2/js/select2.min.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>

        <script src="assets/plugins/moment/moment.min.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>
        <script src="assets/js/bootstrap-datetimepicker.min.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>

        <script src="assets/plugins/summernote/dist/summernote-lite.min.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>

        <script src="assets/js/script.js" type="0b9453024dfd853b288bbaa3-text/javascript"></script>
        <script src="assets/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="0b9453024dfd853b288bbaa3-|49" defer></script></body>

    <!-- Mirrored from kofejob.dreamstechnologies.com/html/template/developer-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2024 10:30:15 GMT -->
</html>