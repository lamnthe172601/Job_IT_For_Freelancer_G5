                            ...
                            <div class="settings-widget">
                                <div class="settings-header d-sm-flex flex-row flex-wrap text-center text-sm-start align-items-center">
                                    ...
                                    <div class="ms-sm-3 ms-md-0 ms-lg-3 mt-2 mt-sm-0 mt-md-2 mt-lg-0">
                                        <h3 class="mb-0"><a href="freelancer-profile.html">${freelancer.fullname()}</a><img src="assets/img/icon/verified-badge.svg" class="ms-1" alt="Img"></h3>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" value="${freelancer.dob}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="pro-body  skill-info">                                                                              
                                                        <div class="form-row align-items-center skill-cont">
                                                            <div class="input-block col-md-6">
                                                                <input type="text" class="form-control" value="${skills.skill_set_ID.skill_set_name}">
                                                            </div>
