<%-- Document : PopularPost Created on : May 28, 2024, 1:28:46 PM Author : DUC MINH --%>
            ...
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <body class="dashboard-page">
                                    ...
                                    <div class="main-menu-wrapper">
                                        ...
                                        <ul class="main-nav">
                                            ...
                                            <c:if test="${sessionScope.account.roleID.getRoleID() == 4}">
                                                ...
                                                <li class="has-submenu">
                                                    <a href="javascript:void(0);">My Post<i
                                                            class="fas fa-chevron-down"></i></a>
                                                    <ul class="submenu">
                                            ...
                                            <c:if test="${sessionScope.account.roleID.getRoleID() == 4}">
                                                <li class="has-submenu">
                                                    <a href="javascript:void(0);">Hello ${sessionScope.account.username}
                                            ...
                                            <c:if
                                                test="${sessionScope.account.roleID.getRoleID() == 1 || sessionScope.account.roleID.getRoleID() == 2}">
                                                <li>
                                            ...
                                            <c:if test="${sessionScope.account == null}">
                                                <li><a href="Register" class="reg-btn"><img
                                                            src="assets/img/icon/users.svg" class="me-1"
                                                            alt="img">Register</a></li>
                                                <li><a href="login" class="log-btn active"><img
                                                            src="assets/img/icon/lock.svg" class="me-1" alt="img">
                                                        Login</a></li>
                                            </c:if>
                                        </ul>
                                    </div>
                                                            ...
                                                            <a href="notification.html">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <p class="noti-details">Notifications inform you
                                                                            when someone likes, reacts</p>
                                                                        <p class="noti-time"><span
                                                                                class="notification-time">Yesterday at
                                                                                11:42 PM</span></p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            ...
                                                            <a href="notification.html">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <p class="noti-details"> Notifications alert you
                                                                            to new messages in your Kofejob inbox.</p>
                                                                        <div class="notification-btn">
                                                                            <span class="btn btn-primary">Accept</span>
                                                                            <span
                                                                                class="btn btn-outline-primary">Reject</span>
                                                                        </div>
                                                                        <p class="noti-time"><span
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <p class="noti-details">Notifications inform you
                                                                            when someone likes, reacts</p>
                                                                        <p class="noti-time"><span
                                                                                class="notification-time">Last Wednesday
                                                                                at 11:15 AM</span></p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                            ...
                                            <li class="nav-item dropdown account-item">
                                                ...
                                                <div class="dropdown-menu emp">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="MyProfile?id=${sessionScope.account.userID}"><img
                                                            src="assets/img/icon/user-dropdown-icon--01.svg" alt="Img">
                                                        My Profile</a>
                                                    <a class="dropdown-item" href="ListApply"><img
                                                            src="assets/img/icon/user-dropdown-icon--02.svg" alt="Img">
                                                        Applied</a>

                                                    <a class="dropdown-item"
                                                        href="UpdateProfile?id=${sessionScope.account.userID}"><img
                                                            src="assets/img/icon/user-dropdown-icon--06.svg" alt="Img">
                                                        Profile Settings</a>
                                                    <a class="dropdown-item" href="logout"><img
                                                            src="assets/img/icon/user-dropdown-icon--07.svg" alt="Img">
                                                        Logout</a>
                                                </div>
                                            </li>
                                        </c:if>
                                    ...
                                    <div class="col-xl-3 col-lg-4 theiaStickySidebar">
                                        <div class="settings-widget">
                                            <div
                                                ...
                                                <a href="MyProfile?id=${sessionScope.account.userID}"><img
                                                        alt="profile image" src="${freelancer.image}"
                                            ...
                                            <div class="settings-menu">
                                                <div id="sidebar-menu" class="sidebar-menu">
                                                    <ul>
                                                        <li class="nav-item">
                                                            <a href="MyProfile?id=${sessionScope.account.userID}"
                                                                class="nav-link ">
                                                                <img src="assets/img/icon/sidebar-icon-01.svg"
                                                                    alt="Img"> My Profile
                                                            </a>
                                                        </li>
                                                        <li class="nav-item submenu">
                                                            <a href="ListApply" class="nav-link">
                                                                <img src="assets/img/icon/sidebar-icon-02.svg"
                                                                    alt="Img"> Applied
                                                                <!--                                                    <span class="menu-arrow"></span>-->
                                                            </a>
                                                            <ul class="sub-menu-ul">
                                                                <li>
                                                                    <a href="freelancer-project-proposals">My
                                                                        Proposal</a>
                                                                </li>
                                                                <li>
                                                                    <a href="freelancer-ongoing-projects">Ongoing
                                                                        Projects</a>
                                                                </li>
                                                                <li>
                                                                    <a href="freelancer-completed-projects">Completed
                                                                        Projects</a>
                                                                </li>
                                                                <li>
                                                                    <a href="freelancer-cancelled-projects">Cancelled
                                                                        Projects</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item submenu">
                                                            <a href="PostFavourites" class="nav-link active">
                                                                <img src="assets/img/icon/sidebar-icon-03.svg"
                                                                    alt="Img"> Favourites
                                                                <!--                                                    <span class="menu-arrow"></span>-->
                                                            </a>
                                                            <ul class="sub-menu-ul">
                                                                <li>
                                                                    <a href="freelancer-favourites">Bookmarked
                                                                        Projects</a>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <li class="nav-item submenu">
                                                            <a href="UpdateProfile?id=${sessionScope.account.userID}"
                                                                class="nav-link ">
                                                                <img src="assets/img/icon/sidebar-icon-10.svg"
                                                                    alt="Img"> Settings
                                                                <!--                                                    <span class="menu-arrow"></span>-->
                                                            </a>
                                                            <ul class="sub-menu-ul">
                                                                <li>
                                                                    <a class="active"
                                                                        href="freelancer-profile-settings.html">Profile
                                                                        Setting</a>
                                                                </li>
                                                                <li>
                                                                    <a href="freelancer-membership.html">Plan &
                                                                        Billing</a>
                                                                </li>
                                                                <li>
                                                                    <a href="freelancer-verify-identity.html">Verify
                                                                        Identity</a>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="logout" class="nav-link">
                                                                <img src="assets/img/icon/sidebar-icon-11.svg"
                                                                    alt="Img"> Logout
                                                            </a>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div>
                                            <form action="PostFavourites" method="post"
                                                class="form-inline my-2 my-lg-0">
                                                <div class="input-group input-group-sm">
                                                    <c:if test="${txtSearch != null}">
                                                        <input name="searchName" type="text" value="${txtSearch}"
                                                ...
                                                <c:forEach items="${post}" var="p">
                                                    <div class="col-md-6 col-lg-12 col-xl-4">
                                                        <div class="freelance-widget widget-author">
                                                            <div class="freelance-content">
                                                                <div class="freelance-top-content d-flex">
                                                                    <span> <i
                                                                            class="feather-clock me-1"></i>${p.datePost}</span>
                                                                    <a class="favourite color-active"
                                                                        class="dropdown-item typeChange"
                                                                        class="btn btn-sm btn-danger "
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#delete${p.postID}"><i
                                                        ...
                                                        <div class=" freelance-info">
                                                                                <h3><a
                                                                                        href="javascript:void(0);">${p.caID.categoriesName}</a>
                                                                                </h3>
                                                                                <div class="freelance-location"><i
                                                                                        class="feather-map-pin me-1"></i>${p.location}
                                                                                </div>
                                                                        </div>
                                                                        <div class="freelance-tags">
                                                                            <c:forEach items="${fn:split(p.skill, ',')}"
                                                                                var="skill" varStatus="loop">
                                                                                <c:if test="${loop.index < 3}">
                                                                                    <span
                                                                                        class="badge badge-pill badge-design">${skill}</span>
                                                                                </c:if>
                                                                                <c:if
                                                                                    test="${loop.index == 2 and not loop.last}">
                                                                                    <span
                                                                                        class="badge badge-pill badge-design">...</span>
                                                                                </c:if>
                                                                            </c:forEach>
                                                                        </div>
                                                                    </div>
                                                                    <div class="counter-stats">
                                                                        <ul>
                                                                            <li class="class3">
                                                                                <h3>Duration</h3>
                                                                                <h5 class="counter-value ">
                                                                                    ${p.durationID.durationName}</h5>
                                                                            </li>
                                                                            <li class="class3">
                                                                                <h3>Quantity</h3>
                                                                                <h5 class="counter-value "
                                                                ...
                                                                <div class="cart-hover">
                                                                    <a href="javascript:void(0);"
                                                                        onclick="openPopup(${p.postID})"
                                                                        class="btn-cart1 classbtn" tabindex="-1">View
                                                                        Details</a>
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${applied}">
                                                                            <a class="btn-cart1 apply"
                                                                                tabindex="-1">Applied</a>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <a data-bs-toggle="modal"
                                                                                data-bs-target="#applyModal_${p.postID}"
                                                                                id="applyButton_${p.postID}"
                                                                                class="btn-cart1 apply-button classbtn"
                                                            ...
                                                            <div class="modal custom-modal fade"
                                                                id="applyModal_${p.postID}" role="dialog">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-body">
                                                                            <div class="form-header">
                                                                                <input type="hidden" class="user-id1"
                                                                                    id="">
                                                                                <h3>Status</h3>
                                                                                <p>Submit your resume so employers can
                                                                                    know more about you.</p>
                                                                            </div>
                                                                            <div class="modal-btn Suspend-action">
                                                                                <form
                                                                                    id="jobApplicationForm_${p.postID}"
                                                                                    action="ApplyJob" method="post"
                                                                                    enctype="multipart/form-data"
                                                                                    onsubmit="return validateForm('${p.postID}')">
                                                                                    <div class="row">
                                                                                        <div
                                                                                            style='margin-bottom: 30px'>
                                                                                            <input
                                                                                                oninput="check('${p.postID}')"
                                                                                                class='file' type='file'
                                                                                                id='fileInput_${p.postID}'
                                                                                                name="file" />
                                                                                            <div style="color: red"
                                                                                                id="error_${p.postID}">
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            ...
                                                                                            <button
                                                                                                id="submitButton_${p.postID}"
                                                                                                class="btn btn-primary confirm-btn"
                                                                                                type="submit"
                                                                                                onclick="submitForm('${p.postID}')">Submit</button>
                                                                                        </div>
                                                                                        <div class="col-6 ">
                                                                                            <!-- Nút "Cancel" để đóng modal -->
                                                                                            <a data-bs-dismiss="modal"
                                                                                                class="btn btn-primary confirm-btn">Cancel</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                            ...
                                                            <div class="modal custom-modal fade" id="delete${p.postID}"
                                                                role="dialog">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-body">
                                                                            <div class="form-header">
                                                                                <input type="hidden" class="user-id1"
                                                                                    id="">
                                                                                <h3>Status</h3>
                                                                                <p>Deleting this will remove it
                                                                                    permanently. Are you sure?</p>
                                                                            </div>
                                                                            <div class="modal-btn Suspend-action">
                                                                                <div class="row">
                                                                                    <div class="col-6">
                                                                                        <a id="deleteLink_${p.postID}"
                                                                                            href="DeletePostFavourites?postID=${p.postID}"
                                                                                            class="btn btn-primary cancel-btn">Yes</a>
                                                                                    </div>
                                                                                    <div class="col-6">
                                                                                        <a data-bs-dismiss="modal"
                                                                ...
                                                                <div class="popup-content">
                                                                    <div class="freelance-content">
                                                                        ...
                                                                        <div class="author-heading">
                                                                            ...
                                                                            <div class="freelance-tags class1"
                                                                                style="margin: 0;padding: 0; margin-top: 10px;margin-right: 20px">
                                                                                Skill:
                                                                                <c:forEach
                                                                                    items="${fn:split(p.skill, ',')}"
                                                                                    var="skill">
                                                                                    <span
                                                                                        class="badge badge-pill badge-design class4">${skill}</span>
                                                                                </c:forEach>
                                                                        ...
                                                                        <div class="freelance-info">
                                                                            ...
                                                                            <div>
                                                                                <div class="class1"
                                                                                    style="display: inline-block;">Jop
                                                                                    Type:</div>
                                                                                <div class="class2"
                                                                                    style="display: inline-block; margin-left: 5px;">
                                                                            ...
                                                                            <a href="PostDetails?postID=${p.postID}"
                                                                                class="btn-cart1 viewmore"
                                                                                style="text-align: center; margin-left: 32%; margin-top: 30px"
                                                                                tabindex="-1">More Detail</a>
                                                                        </div>
                                                                    </div>
                                                                    <span class="close"
                                                                        onclick="closePopup(${p.postID})">&times;</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul class="paginations list-pagination">
                                                            ...
                                                            <c:forEach begin="1" end="${endPage}" var="e">
                                                                ...
                                                                <li class="page-item"><a class="${tag == e?"
                                                                        active":""}"
                                                                        href="PostFavourites?index=${e}">${e}</a></li>
                                ...
                                <div class="modal-body">
                                    <form action="#">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="average-bids">
                                                        <p>Contact <span class="text-highlight">John Doe </span> about
                                                            your Project</p>
                                                    </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group form-inline">
                                                                    ...
                                                                    <input type="text" class="form-control me-1"
                                                                        placeholder="20.00"> <label class="form-label">/
                                                                        hr</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-block">
                                                        ...
                                                        <select class="form-control select">
                                                            <option value="0">3D Renders and Amazon Product Store
                                                                images/Video</option>
                                                            <option value="0">3D Renders and Amazon Product Store Video
                                                            </option>
                                                            <option value="0">3D Renders and Amazon Product Store images
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="submit-section text-end">
                                            <button type="submit" class="btn btn-primary submit-btn">Send
                                                Invite</button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                <div class="modal-header d-block b-0 pb-0">
                                    <span class="modal-close float-end"><a href="javascript:void(0);"
                    ...
                    <script src="assets/js/jquery-3.7.1.min.js"
                        type="e07a54eb38ecbc80607f458c-text/javascript"></script>
                    ...
                    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
                        data-cf-settings="e07a54eb38ecbc80607f458c-|49" defer></script>
                    <script src="assets/js/bootstrap.bundle.min.js"
                        type="39bd9d3b5f9a12b82c2bbcef-text/javascript"></script>
                    <script src="assets/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
                        data-cf-settings="39bd9d3b5f9a12b82c2bbcef-|49" defer></script>
                </body>
