...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="card-body pt-0">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-7">
                                                <p>Welcome back,</p>
                                                <h6 class="text-primary">${account.getUsername()}</h6>
                                            </div>
                                                ...
                                                <table class="table table-hover table-center mb-0 datatable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-01.jpg" alt="User Image">
                                                                        George Wells
                                                                    </a>
                                                                </h2>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-15.jpg" alt="User Image">
                                                                        Timothy Smith
                                                                    </a>
                                                                </h2>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-16.jpg" alt="User Image">
                                                                        Lois Alexander
                                                                    </a>
                                                                </h2>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-03.jpg" alt="User Image">
                                                                        Sara Grayson
                                                                    </a>
                                                                </h2>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-11.jpg" alt="User Image">
                                                                        Sofia Briant
                                                                    </a>
                                                                </h2>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-02.jpg" alt="User Image">
                                                                        Bess Twishes
                                                                    </a>
                                                                </h2>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-06.jpg" alt="User Image">
                                                                        Sarah Alexander
                                                                    </a>
                                                                </h2>
                                                            </td>
                                                ...
                                                <table class="table table-bordered table-hover datatable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="adminAssets/img/profiles/avatar-10.jpg" alt="User Image">
                                                                        Gary Green
                                                                    </a>
                                                                </h2>
                                                            </td>
        ...
        <script src="adminAssets/js/jquery-3.7.1.min.js" type="164eb6d6a75caec95434e247-text/javascript"></script>

        <script src="adminAssets/js/bootstrap.bundle.min.js" type="164eb6d6a75caec95434e247-text/javascript"></script>

        <script src="adminAssets/js/feather.min.js" type="164eb6d6a75caec95434e247-text/javascript"></script>

        <script src="adminAssets/plugins/slimscroll/jquery.slimscroll.min.js" type="164eb6d6a75caec95434e247-text/javascript"></script>

        <script src="adminAssets/plugins/select2/js/select2.min.js" type="164eb6d6a75caec95434e247-text/javascript"></script>

        <script src="adminAssets/plugins/datatables/jquery.dataTables.min.js" type="164eb6d6a75caec95434e247-text/javascript"></script>
        <script src="adminAssets/plugins/datatables/datatables.min.js" type="164eb6d6a75caec95434e247-text/javascript"></script>
        <script src="https://cdn.jsdelivr.net/npm/apexcharts" type="164eb6d6a75caec95434e247-text/javascript"></script>

        <script src="adminAssets/js/script.js" type="164eb6d6a75caec95434e247-text/javascript"></script>
        <script src="assets/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="164eb6d6a75caec95434e247-|49" defer></script></body>
